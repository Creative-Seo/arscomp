...
<form class="form-horizontal" role="form" action="/kontakty" method="post" id="contact-form">
		<legend>Отправить сообщение. Все поля, отмеченные звездочкой, являются обязательными.</legend>
		
		<div class="form-group">
			<label id="jform_contact_name-lbl" for="inputtext" class="col-sm-2 control-label" title="" data-original-title="<strong>Имя</strong><br />Ваше имя">Имя<span class="star">&nbsp;*</span>
			</label>
		<div class="col-sm-10">			
		...
		<div class="form-group">
			<label id="jform_contact_email-lbl" for="inputEmail3" class="col-sm-2 control-label" title="" data-original-title="<strong>E-mail</strong><br />Адрес электронной почты контакта">E-mail<span class="star">&nbsp;*</span>
			</label>
		<div class="col-sm-10">				
		...
		<div class="form-group">
			<label id="jform_contact_emailmsg-lbl" for="inputtext" class="col-sm-2 control-label" title="" data-original-title="<strong>Тема</strong><br />Тема сообщения">Тема<span class="star">&nbsp;*</span>
			</label>
		<div class="col-sm-10">			
		...
		<div class="form-group">
			<label id="jform_contact_message-lbl" for="jform_contact_message" class="col-sm-2 control-label" title="" data-original-title="<strong>Сообщение</strong><br />Введите текст вашего сообщения">Сообщение<span class="star">&nbsp;*</span>
			</label>
		<div class="col-sm-10">			
	...
	<input type="hidden" name="38aeb1413c7ebd7e296cf495852a6d92" value="1">
