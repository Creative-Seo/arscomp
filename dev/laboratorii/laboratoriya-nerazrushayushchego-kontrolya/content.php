...
<p><img style="float: right;" src="/images/matc/kontrol/prom-bezopasnost-okpars.ru-02.jpg" alt="<?php echo $h1;?>" title="<?php echo $h1;?>" width="300" class="size-auto"></p>
<p>&nbsp;Основные методы НК:&nbsp;<span style="line-height: 1.3em;">&nbsp;</span></p>
...
<p>Объекты, подлежащие НК:<span style="line-height: 1.3em;">&nbsp;</span></p>
    <ul style="list-style-type: circle;">
<li>Котлонадзор;</li>
<li>Газоснабжение;</li>
...
<p>Задачи НК в научно-исследовательских и опытно-конструкторских работах:</p>
    <ul style="list-style-type: circle;">
...
<p>Результаты НК используются с целью изменения конструкций и технического процесса в сторону оптимизации уровня расходов на производстве, а также повышения износостойкости и надежности выпускаемой продукции.&nbsp;</p>
	...
	<aside id="sidebar-a" class="grid-box"><div class="grid-box width100 grid-v"><div class="module mod-box colored deepest">
			...
			<a href="/laboratorii/radiotekhnicheskaya-laboratoriya" class="level1"><span>Радиотехническая лаборатория</span></a>
			    ...
			    <li class="level1 item150 active">
			<a href="/laboratorii/laboratoriya-nerazrushayushchego-kontrolya" class="level1 active"><span>Лаборатория неразрушающего контроля</span></a>
			    </li>
