...
<p>Цели исследовательских работ радиотехнической лаборатории:</p>
...
<p>Задокументированные результаты исследований, проводимых в нашей лаборатории, отличаются максимальной точностью и соответствуют всем необходимым требованиям и стандартам. Плановый контроль за радиотехникой и средствами связи — залог успешного функционирования и развития Вашего предприятия.&nbsp;</p>
	...
	<aside id="sidebar-a" class="grid-box"><div class="grid-box width100 grid-v"><div class="module mod-box colored deepest">
			...
			<a href="/laboratorii/elektrotekhnicheskaya-laboratoriya" class="level1"><span>Электротехническая лаборатория</span></a>
			    ...
			    <li class="level1 item175 active">
			<a href="/laboratorii/radiotekhnicheskaya-laboratoriya" class="level1 active"><span>Радиотехническая лаборатория</span></a>
			    </li>
