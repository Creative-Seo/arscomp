...
<p>Преимущества автономной газификации:</p>
        <ul style="list-style-type: circle;">
    <li>Возможность выбора места жительства (постройка частного жилого дома или коттеджа) независимо от степени близости к центральным сетям газоснабжения;</li>
    <li>Удобные сроки установки и легкость эксплуатации;</li>
    <li>Возможность самостоятельного регулирования расходов топлива и горячей воды;</li>
    <li>Полная независимость от коммунальных сетей;</li>
    <li>Стабильность цен на топливо;</li>
    <li>Последовательная экономия средств;&nbsp;</li>
    <li>Экологичность.</li>
        </ul>
<p><span style="line-height: 1.3em;">Продукция ООО ОКП «АРС» соответствует всем актуальным требованиям и стандартам. Каждый из выпускаемых резервуаров имеет федеральную лицензию и все необходимые сертификаты, выданные Ростехнадзором.&nbsp;</span></p>
<p>Наши преимущества:</p>
        <ul style="list-style-type: circle;">
    <li>Индивидуальный подход к пожеланиям и возможностям каждого из наших клиентов. Исходя из потребностей заказчика, наши специалисты установят на вашем участке от одного до нескольких резервуаров.</li>
    <li>Услуги высококвалифицированных специалистов-аналитиков — осуществление анализа требуемой мощности водонагревательной системы, проектирование газопровода, выбор оптимального числа резервуаров.&nbsp;</li>
    <li>Надежность, износостойкость и безопасность продукции. Каждый из газгольдеров снабжен полимер-эпоксидным покрытием и катодной защитой.</li>
...
<p><img src="/images/matc/gaz/avtonomka-gaz-1-okpars.ru.jpg" alt="<?php echo $h1;?>" title="<?php echo $h1;?>" width="430" height="288" class="size-auto"><img src="/images/matc/gaz/avtonomka-gaz-3-okpars.ru.jpg" alt="<?php echo $h1;?>" title="<?php echo $h1;?>" width="430" height="310" class="size-auto"></p>
	...
	<a href="/pozharnaya-bezopasnost" class="level1"><span>Пожарная безопасность</span></a>
	    ...
	    <li class="level1 item182 active">
	<a href="/avtonomnaya-gazafikatsiya" class="level1 active"><span>Автономная Газафикация</span></a>
	    </li>
