...
<div class="sprocket-tabs-panel" data-tabs-panel="">
	<h3 class="tab-title"><strong>Штат</strong>&nbsp;сотрудников компании</h3>
<p><img class="hidden-img size-auto" src="/images/okpars.ru/tabs/niche.png" alt="image" border="0"></p>
...
//]]>
				...
				<!-- maininner end -->
								...
								<aside id="sidebar-a" class="grid-box" style="min-height: 612px;"><div class="grid-box width100 grid-v"><div class="module mod-box  deepest">
