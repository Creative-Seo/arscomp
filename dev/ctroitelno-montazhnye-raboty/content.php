...
<p><img style="float: right;" src="/images/matc/stroyka/stroitelstvo-okpars.ru-02.jpg" alt="<?php echo $h1;?>" title="<?php echo $h1;?>" width="300" class="size-auto"></p>
        ...
        <li>Кровельные работы.<img style="float: right;" src="/images/matc/stroyka/stroitelstvo-okpars.ru-04.jpg" alt="<?php echo $h1;?>" title="<?php echo $h1;?>" width="300" class="size-auto"></li>
	...
	<a href="/proektirovanie-ob-ektov-linejnogo-sooruzheniya" class="level1"><span>Проектирование объектов линейного сооружения</span></a>
	    ...
	    <li class="level1 item178 active">
	<a href="/ctroitelno-montazhnye-raboty" class="level1 active"><span>Строительно-монтажные работы</span></a>
	    </li>
	...
	<a href="http://пробуримся.рф/" class="level1" rel="nofollow"><span>Бурение скваижн</span></a>
	    </li>
	        </ul>		
</div>
</div>
